...
router.get('/google-config', authCtrl.getGoogleConfig);
router.post('/google',   authCtrl.googleAuth);
router.get('/google-settings', authenticateJWT, adminOnly, authCtrl.getGoogleSettings);
router.put('/google-settings', authenticateJWT, adminOnly, authCtrl.updateGoogleSettings);
