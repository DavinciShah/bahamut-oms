...
function validateInvoice(invoice) {
  ...
  if (!invoice.customerName && !invoice.zohoCustomerId) return 'Customer name or Zoho customer ID is required';
...
function validatePayment(payment) {
  ...
  if (!payment.zohoCustomerId) return 'Zoho customer ID is required';
